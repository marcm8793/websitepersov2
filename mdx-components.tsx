    ...
    code: ({ className, ...props }: React.HTMLAttributes<HTMLElement>) => (
      <code
        className={cn(
          ...
          // Don't apply background to code inside pre elements (syntax highlighted blocks)
          "data-[highlighted]:bg-transparent data-[highlighted]:px-0 data-[highlighted]:py-0",
          className
        )}
        {...props}
      />
